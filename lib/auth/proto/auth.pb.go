...
func (Operation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_auth_e59ac22ed9e928eb, []int{0}
}
...
func (*Watch) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_e59ac22ed9e928eb, []int{1}
}
...
func (*WatchKind) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_e59ac22ed9e928eb, []int{2}
}
...
func (*Certs) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_e59ac22ed9e928eb, []int{3}
}
...
func (*UserCertsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_e59ac22ed9e928eb, []int{4}
}
...
func (*GetUserRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_e59ac22ed9e928eb, []int{5}
}
...
func (*GetUsersRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_e59ac22ed9e928eb, []int{6}
}
...
func (*AccessRequests) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_e59ac22ed9e928eb, []int{7}
}
...
func (*PluginDataSeq) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_e59ac22ed9e928eb, []int{8}
}
...
func (*RequestStateSetter) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_e59ac22ed9e928eb, []int{9}
}
...
func (*RequestID) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_e59ac22ed9e928eb, []int{10}
}
...
func (*RotateResetPasswordTokenSecretsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_e59ac22ed9e928eb, []int{11}
}
...
func (*GetResetPasswordTokenRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_e59ac22ed9e928eb, []int{12}
}
...
func (*CreateResetPasswordTokenRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_e59ac22ed9e928eb, []int{13}
}
...
func (*PingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_e59ac22ed9e928eb, []int{14}
}
...
func (*PingResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_e59ac22ed9e928eb, []int{15}
}
...
// AcquireSemaphore contians semaphore acquisition parameters.
type AcquireSemaphore struct {
	// Semaphore is the expected semaphore configuration.
	Semaphore *services.SemaphoreV3 `protobuf:"bytes,1,opt,name=Semaphore" json:"semaphore"`
	// Lease is the specific lease being acquired.
	Lease                *services.SemaphoreLease `protobuf:"bytes,2,opt,name=Lease" json:"lease"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
func (*AcquireSemaphore) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_e59ac22ed9e928eb, []int{16}
}
...
func (m *AcquireSemaphore) GetSemaphore() *services.SemaphoreV3 {
	if m != nil {
		return m.Semaphore
	}
	return nil
...
func (m *AcquireSemaphore) GetLease() *services.SemaphoreLease {
	if m != nil {
		return m.Lease
	}
	return nil
...
func (*Semaphores) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_e59ac22ed9e928eb, []int{17}
}
...
func init() {
	...
	proto.RegisterType((*AcquireSemaphore)(nil), "proto.AcquireSemaphore")
...
type AuthServiceClient interface {
	...
	TryAcquireSemaphore(ctx context.Context, in *AcquireSemaphore, opts ...grpc.CallOption) (*services.SemaphoreLease, error)
	...
	GetAllSemaphores(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Semaphores, error)
}
...
func (c *authServiceClient) TryAcquireSemaphore(ctx context.Context, in *AcquireSemaphore, opts ...grpc.CallOption) (*services.SemaphoreLease, error) {
	out := new(services.SemaphoreLease)
	err := c.cc.Invoke(ctx, "/proto.AuthService/TryAcquireSemaphore", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) GetAllSemaphores(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Semaphores, error) {
	out := new(Semaphores)
	err := c.cc.Invoke(ctx, "/proto.AuthService/GetAllSemaphores", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	// TryAcquireSemaphore acquires lease with requested resources from semaphore.
	TryAcquireSemaphore(context.Context, *AcquireSemaphore) (*services.SemaphoreLease, error)
	// KeepAliveSemaphoreLease updates semaphore lease.
	...
	// GetAllSemaphores returns a list of all semaphores in the system.
	GetAllSemaphores(context.Context, *empty.Empty) (*Semaphores, error)
}
...
func _AuthService_TryAcquireSemaphore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AcquireSemaphore)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).TryAcquireSemaphore(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AuthService/TryAcquireSemaphore",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).TryAcquireSemaphore(ctx, req.(*AcquireSemaphore))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AuthService_GetAllSemaphores_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(empty.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).GetAllSemaphores(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AuthService/GetAllSemaphores",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetAllSemaphores(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AuthService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TryAcquireSemaphore",
			Handler:    _AuthService_TryAcquireSemaphore_Handler,
		},
		{
		...
		{
			MethodName: "GetAllSemaphores",
			Handler:    _AuthService_GetAllSemaphores_Handler,
		},
	},
...
func (m *AcquireSemaphore) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Semaphore != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintAuth(dAtA, i, uint64(m.Semaphore.Size()))
		n16, err := m.Semaphore.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
	...
	if m.Lease != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintAuth(dAtA, i, uint64(m.Lease.Size()))
...
func (m *AcquireSemaphore) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Semaphore == nil {
				m.Semaphore = &services.SemaphoreV3{}
			}
		...
		case 2:
			...
			if m.Lease == nil {
				m.Lease = &services.SemaphoreLease{}
			}
...
func init() { proto.RegisterFile("auth.proto", fileDescriptor_auth_e59ac22ed9e928eb) }

var fileDescriptor_auth_e59ac22ed9e928eb = []byte{
	...
	,
}
